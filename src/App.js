...
function Formulario({crearCita}){
  ...
  //pasamos la cita al comp principal
  const enviarCita = e => {
    e.preventDefault();
...
function App() {
  ...
  const crearCita = cita => {
    //tomar una copia del state y agregar el nuevp cliente
  ...
  const titulo = Object.keys(citas).length === 0 ? 'No hay citas' : 'Administrat las citas aqui';
